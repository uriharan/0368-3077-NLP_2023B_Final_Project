...
def Load_Model_From_Pretrained(AutoModelLib,name_from_pretrained):
    ...
    model = AutoModelLib.from_pretrained(name_from_pretrained, device_map="auto", offload_folder="offload", offload_state_dict = True, load_in_4bit=True, low_cpu_mem_usage=True, torch_dtype=torch.bfloat16)
