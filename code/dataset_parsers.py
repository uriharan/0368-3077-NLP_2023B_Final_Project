...
# For both hindi-english and english-french datasets
def parse_English_Translation(in_vec,to_english,other_lang):
    var_from = other_lang if to_english else "english"
    var_to = "english" if to_english else other_lang
    for item in in_vec:
